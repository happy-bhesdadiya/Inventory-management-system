...
const updateProfile=async(req,res,next)=>{
     try{
          ...
          const c1= await User.update({user_name:req.body.user_name,mobile_number:req.body.mobile_number,password:req.body.password,branch_id:req.body.branch_id,profile_pic:req.body.profile_pic,is_admin:req.body.is_admin,is_active:req.body.is_active},{where:{
              email:req.body.email
           }})
           ...
           {
               res.status(200);
               return res.json(errorFunction(false, "Employee Data Updated Succesfully"));
           }
           else{
               res.status(404);
